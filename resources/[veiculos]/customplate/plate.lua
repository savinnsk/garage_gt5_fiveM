--- IMAGE CONFIG HERE ---
imageUrl = "https://i.imgur.com/b1icsdb.png" -- Paste your image URL here (doesn't have to be from imgur)


-- The actual script --
local textureDic = CreateRuntimeTxd('duiTxd') -- Create custom texture dictionary only needs to be done once
local object = CreateDui(imageUrl, 600, 350) -- Load image into object
...
local object = CreateDui('https://i.imgur.com/Q3uw6V7.png', 600, 350) -- this URL doesn't need to be edited, its just the 2d model for the plate -- Load image into object
local handle = GetDuiHandle(object) -- Gets DUI handle from object
